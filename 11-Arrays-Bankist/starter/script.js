...
// 1
const recommendedFoodFunc = function (dog) {
  dog.forEach(weight => {
    const recFood = Math.trunc(weight.weight ** 0.75 * 28);
    weight.recommendedFood = recFood;
  });
};

recommendedFoodFunc(dogs);
console.log(dogs);
